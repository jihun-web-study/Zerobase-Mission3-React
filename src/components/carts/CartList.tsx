...
const CartList = (): JSX.Element => {
  ...
  const sampleProduct = useRecoilValue(productsList);
      ...
      <div className="lg:flex lg:items-center mt-4 px-2 lg:px-0">
        ...
        <div className="card-body px-1 lg:px-12">
          ...
          <p className="mt-2 mb-4 text-3xl">
            {toCurrencyFormat(item.price * tempCount)} <span className="text-2xl">{toCurrencyFormat(item.price)}</span>
          </p>
          <div className="card-actions">
            <div className="btn-group">
              ...
              <button className="btn btn-ghost no-animation">1</button>
  ...
  return (
    <>
      {[sampleProduct[0], sampleProduct[1], sampleProduct[2]].map((v) => (
