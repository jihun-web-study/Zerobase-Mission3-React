...
const NavSettingView = () => {
  ...
  useEffect(() => {
    // 테마를 토글할때마다 로컬스토리지에 값 저장 & html 테마 변경
  ...
  return (
    <label className="swap swap-rotate mr-2 sm:mr-4">
      <input type="checkbox" className="js-theme" onClick={toggleTheme} checked={theme === "dark"} />
